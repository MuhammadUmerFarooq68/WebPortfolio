      ...
      <div className="middle text-white section  px-10 flex md:flex-row flex-col gap-10 items-center justify-between md:items-start relative md:py-10">
        <div className="left md:sticky md:top-28 left-0 md:w-[40%] w-[20rem]">
          ...
          <button className="mt-10" title="CV">
            <a
              href="https://drive.google.com/file/d/1UU__r-f7O19lW4Jua5YWgVQu8C-kgOKh/view?usp=drive_link"
              target="_blank"
        ...
        >
          ...
          I am an aspiring software developer proficient in the MERN stack (MongoDB, Express.js, React, and Node.js), with a solid foundation in full-stack development. I enjoy building dynamic and scalable web applications, leveraging both frontend and backend technologies. Passionate about creating seamless user experiences, I am eager to collaborate on innovative projects that utilize the power of JavaScript across the entire development process
