...
function Blogpage() {
  ...
  useEffect(() => {
    async function fetchMainArticles() {
      try {
        const articleLinks = [
          "https://dev.to/umerfarooq68/beyond-code-the-artistry-of-mvc-in-crafting-dynamic-applications-4e8n",
          // "https://medium.com/@engr.umerfarooq68/integrating-phpmyadmin-with-a-node-js-and-express-js-application-4f666160cbf1"
    ...
    async function fetchTotalReads() {
      try {
        const authorProfileResponse = await axios.get("https://dev.to/umerfarooq68/beyond-code-the-artistry-of-mvc-in-crafting-dynamic-applications-4e8n");
