        ...
        <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4 transition-all duration-300 ease-in-out border-b-2 border-transparent">
          ...
          >
            <span className="md:text-2xl text-xl tracking-wide whitespace-nowrap">
              Muhammad 
              <span className="text-[#FF6014] md:text-lg font-semibod">U</span>
             mer
              <span className="text-[#FF6014] md:text-lg font-semibold">F</span>
              arooq
            </span>
          </Link>
          ...
          >
            ...
            <div className="flex items-center h-56 text-xl justify-center gap-6">
              <a
                href="https://github.com/umerfarooq-68"
                target="_blank"
              ...
              <a
                href="https://x.com/EngrUmerfarooq6"
                target="_blank"
                rel="noopener noreferrer"
                class="social-icon"
              >
              ...
              <a
                href="https://www.linkedin.com/in/engr-umer-farooq/"
                target="_blank"
                rel="noopener noreferrer"
                class="social-icon"
              >
